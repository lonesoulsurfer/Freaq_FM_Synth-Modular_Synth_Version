...
// Mozzi 2.0: Use MOZZI_AUDIO_RATE and MOZZI_CONTROL_RATE
// voice 1
Oscil <SIN2048_NUM_CELLS, MOZZI_AUDIO_RATE> carrier1(SIN2048_DATA);
Oscil <SIN2048_NUM_CELLS, MOZZI_AUDIO_RATE> modulator1(SIN2048_DATA);
ADSR <MOZZI_CONTROL_RATE, MOZZI_CONTROL_RATE> envelopeAmp1;
ADSR <MOZZI_CONTROL_RATE, MOZZI_CONTROL_RATE> envelopeMod1;
...
Oscil <SIN2048_NUM_CELLS, MOZZI_AUDIO_RATE>modulator2(SIN2048_DATA);
ADSR <MOZZI_CONTROL_RATE, MOZZI_CONTROL_RATE> envelopeAmp2;
ADSR <MOZZI_CONTROL_RATE, MOZZI_CONTROL_RATE> envelopeMod2;
...
inline void MutatingFM::updateControl()
{
  ...
  // MOZZI_CONTROL_RATE has to be high to reduce jitter in the sequencer but running these calcs at 128hz seems to be too high, so only do it every 2nd call
